...
public class AppiumUpdateCaptureNoReset {
    ...
    public void updateCaptureBenchmarkNoReset() {
        try {
            appiumPlugin.updateCapture();
        } catch (Exception e) {
            System.out.println("Error in updateCapture: " + e.getMessage());
        }
    }
