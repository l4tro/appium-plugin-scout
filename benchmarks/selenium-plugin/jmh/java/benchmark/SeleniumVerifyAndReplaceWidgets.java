...
public class SeleniumVerifyAndReplaceWidgets {
    ...
    public static void setupTrial() {
        ...
        try {
            currentState = SeleniumPlugin.class.getDeclaredField("currentState");
    ...
    public void setupInvocation() throws IllegalAccessException {
        ((AppState) currentState.get(seleniumPlugin)).removeWidgets("SeleniumPlugin");
    }

    @Benchmark
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @BenchmarkMode(Mode.AverageTime)
    public void verifyAndReplaceWidgetsBenchmark() {
        List<Widget> widgets = seleniumPlugin.getAvailableWidgets();
        seleniumPlugin.verifyAndReplaceWidgets(widgets);
    }
